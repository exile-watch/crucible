...
function SvgFormatUnderlineIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgFormatUnderlineIcon = React.memo(SvgFormatUnderlineIcon);
export default MemoSvgFormatUnderlineIcon;
