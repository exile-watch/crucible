...
function SvgFormatBoldIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgFormatBoldIcon = React.memo(SvgFormatBoldIcon);
export default MemoSvgFormatBoldIcon;
