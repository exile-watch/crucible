...
function SvgFormatBulletedListIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgFormatBulletedListIcon = React.memo(SvgFormatBulletedListIcon);
export default MemoSvgFormatBulletedListIcon;
