...
function SvgFormatHeadingTwoIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgFormatHeadingTwoIcon = React.memo(SvgFormatHeadingTwoIcon);
export default MemoSvgFormatHeadingTwoIcon;
