...
function SvgFormatItalicIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoSvgFormatItalicIcon = React.memo(SvgFormatItalicIcon);
export default MemoSvgFormatItalicIcon;
