    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="9157.07 2322.8 1450 1450" {...props}>
      ...
      >
        ...
        <circle
          ...
          fill="var(--secondary-bg)"
          id="skill-64111"
          className="out-32662-59800-32640-14156-20480-50459 s0 root"
        />
        <circle
          cx={9420.183}
          cy={2370.464}
...
const MemoSvgPathfinder = React.memo(SvgPathfinder);
export default MemoSvgPathfinder;
