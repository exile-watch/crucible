    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-8419.2 -3283.22 1450 1450" {...props}>
      ...
      >
        ...
        <circle
          ...
          id="skill-409"
          className="out-37419-32364-46952-32992-40010-61525 s0 root"
        />
        <circle
          cx={-7979.934}
          cy={-2572.473}
